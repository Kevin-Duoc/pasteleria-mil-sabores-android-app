...
val sampleProductos = listOf(
    ...
    Producto(id = "TT002", nombre = "Torta Circular de Manjar", descripcion = "Torta tradicional chilena con manjar y nueces.", precio = 42000, imagenResIdName = "torta_circular_manjar", stock = 10, stockCritico = 5),
    ...
    Producto(id = "PSA002", nombre = "Cheesecake Sin Azúcar", descripcion = "Suave y cremoso, este cheesecake es una opción perfecta para disfrutar sin culpa.", precio = 47000, imagenResIdName = "cheesecake_sin_azucar", stock = 8, stockCritico = 3),
    ...
    Producto(id = "TE002", nombre = "Torta Especial de Boda", descripcion = "Elegante y deliciosa, centro de atención en cualquier boda.", precio = 60000, imagenResIdName = "torta_especial_boda", stock = 2, stockCritico = 1)
)
